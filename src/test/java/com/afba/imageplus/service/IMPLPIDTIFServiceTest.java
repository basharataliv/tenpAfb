...
import com.afba.imageplus.service.impl.IMPLPIDTIFServiceImpl;
import com.afba.imageplus.utilities.AuthorizationHelper;
import com.afba.imageplus.utilities.RangeHelper;

@SpringBootTest(classes = { IMPLPIDTIFServiceImpl.class, ErrorServiceImp.class, DocumentServiceImpl.class,
        RangeHelper.class, AuthorizationHelper.class })
class IMPLPIDTIFServiceTest {
    @MockBean
    ...
    @Test
    void assertThat_onProcessingIssueRecords_recordIsProcessedIfDocumentFileFound() throws IOException {
    ...
    @Test
    void assertThat_onProcessingIssueRecords_recordIsProcessed_andDeffoldCalled_IfDocumentFileFound()
            throws IOException {
