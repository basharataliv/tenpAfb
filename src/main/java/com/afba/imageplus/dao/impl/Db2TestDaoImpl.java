...
@Repository
public class Db2TestDaoImpl implements TestDao {

    private static final Logger logger = LoggerFactory.getLogger(TestDao.class);

    // Auto-wire secondary jdbcTemplate for DB2
    @Autowired
    @Qualifier(ApplicationConstants.SECONDARY_JDBC_TEMPLATE_BEAN)
    ...
    private static final String INSERT_TEST_DATA = "INSERT INTO " + TEST_TABLE_NAME
            + " (id, name, company) VALUES (?,?,?);";
    private static final String GET_TEST_DATA = "select * from " + TEST_TABLE_NAME + ";";
